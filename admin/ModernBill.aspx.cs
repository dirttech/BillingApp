        ...
        try
        {
            ...
            if (map != null)
            {
                ...
                if (frDate != null && tDate != null)
                {
                    ...
                    List<FetchingEnergy> energy = FetchingEnergy_s.fetchBillingData(utFr.Epoch, utTo.Epoch, map.MeterId, map.DeviceId);
                    ...
                    if (energy != null)
                    {
                        ...
                        meterNo.InnerText = map.DeviceId + " - " + map.MeterId.ToString();
                    ...
                    List<FetchingEnergy> ft = FetchingEnergy_s.fetchAVGDashDayEnergy(utFr.Epoch, map.DeviceId, utTo.Epoch-utFr.Epoch);
                    if (ft != null)
                    {
                        float avg = 0;
                        int ctr = 0;
                    ...
                    List<FetchingEnergy> barEnergy = FetchingEnergy_s.fetchEnergyBar(epochs, map.MeterId, map.DeviceId);
