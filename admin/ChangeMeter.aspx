...
<body>
    ...
    <tr>
    <td colspan="3" >
    <div class="HeadingLeftTop" style="background-color:White; line-height:19px;"  >
                <asp:Label ID="Top2" runat="server" Font-Bold="False" style="font-size:large; color:#265D85;" >New MeterId and DeviceId</asp:Label>
    ...
    <td>Device ID</td><td>Meter ID<input type="hidden" runat="server" id="hiddenUser" /></td><td></td>
    </tr>
    <tr>
    <td>
    <asp:TextBox ID="devId" runat="server"></asp:TextBox>
    </td><td>
    ...
    <td>
                ...
                ControlToValidate="metId" Display="Dynamic" ErrorMessage="integer b/w 1-31" 
                MaximumValue="31" MinimumValue="1" SetFocusOnError="True" Type="Integer" ForeColor="white"></asp:RangeValidator>
